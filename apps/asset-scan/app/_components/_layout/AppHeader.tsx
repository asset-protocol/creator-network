...
import { BadgePlus, BookText, CirclePlus, DiamondPlus, FileText, PackagePlus, SwatchBook } from "lucide-react";
...
export function AppHeader() {
  ...
  return (
    <Header className="flex items-center bg-[#E8F3F3] py-[10px] px-0 gap-4">
      <div >
        <Link href="/" className="btn btn-ghost text-xl">Creator Network</Link>
      </div>
      <Menu
        items={items}
        mode="horizontal"
        className="flex-1"
        subMenuOpenDelay={0}></Menu>
      <Dropdown
        transitionName=""
