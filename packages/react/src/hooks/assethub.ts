import {
  ...
  NewAssetHub,
  NewAssetHubManager,
  NewTokenGlobalModule,
  PayableOverrides,
  assethub,
  tokenGlobalModule,
} from '@creator-network/web3';
...
): assethub.DataTypes.AssetCreateDataStruct {
...
export type UpdateAssetInput =
  Partial<assethub.DataTypes.AssetUpdateDataStruct>;

function checkUpdateData(
  data: UpdateAssetInput
): assethub.DataTypes.AssetUpdateDataStruct {
...
export function useGetHubGlobalModuleConfig(
  ...
  const [config, setConfig] =
    useState<tokenGlobalModule.AssetTokenConfigStructOutput>();
